                            ...
                            <div class="card-body">
                                ...
                                <form role="form" method="post" action="login.php" class="text-start">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        <input type="password" name="txtUserPass" class="form-control" placeholder="Password">
                                    </div>
                                ...
                                <?php
                                            ...
                                            echo "<script> Swal.fire({
                                                    icon: 'error',
                                                    title: 'Başarısız',
                                                    text: 'Şifreniz Hatalı. Lütfen Kontrol Edin',
                                                })</script>";
                                        }
                                    }
                                    else{
                                        echo '<script type="text/javascript" src="assets/css/sweetalert2.all.min.js"></script>';
                                            echo "<script> Swal.fire({
                                                    icon: 'error',
                                                    title: 'Başarısız',
                                                    text: 'Kullanıcı Adınız Hatalı. Lütfen Kontrol Edin',
                                                })</script>";
                                    }
                                }
