...
if ($_POST) {
    ...
    try {
        $ekleSorgu = $baglanti->prepare("insert into product set Name=:baslik,CategoryId=:category,Description=:metin,Ingredients=:ingred,Price=:price,
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Menü Öğesi Ekle</h6>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <form class="m-3" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="text" name="Ingredi" value="" class="form-control">
                            </div>
                            <div class="input-group input-group-static my-3">
