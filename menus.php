...
<section class="vertical-menu-list"><!--<form method="post">-->
    ...
    <div class="container">
        ...
        <div class="dark-vertical-menu__options d-flex justify-content-center">
            ...
            <a href="categories.php" class="d-block text-white text-center mb-3">
                <?= $categResult["Name"] ?><i class="fa-solid fa-angle-down ms-2"></i>
            </a>

            <a href="categories.php" class="d-block text-white text-center-lg mb-3">
                <?= $categResult["Name"] ?><i class="fa-solid fa-angle-down ms-2"></i>
            </a>
        ...
        while ($sonuc = $sorgu->fetch()) {
            ...
            <ul class="arabas">
                    ...
                    <div class="row">
                        <div class="col-4 pe-1">
                            <div class="food-background">
                                <div
                                    style="background-image:url(admin/assets/img/<?= $sonuc["ImageUrl"] ?>);height:90%;width:90%;background-size:cover;background-position:center;">
                        ...
                        <div class="col-8">
                            <h6 data-bs-toggle="modal" id="urunclick<?= $sonuc["Id"] ?>"
                                data-bs-target="#menuModal<?= $sonuc["Id"] ?>">
                                <?= $sonuc["Name"] ?>
                            </h6>
                            <p>
                                <?= $sonuc["Description"] ?>
                            ...
                            <span class="text-orange float-start mt-2 me-2">
                                <?= $sonuc["Price"] ?>TL
                            </span>
                            <div class="float-end">
                ...
                <div class="modal modal-bottom fade" id="menuModal<?= $sonuc["Id"] ?>" tabindex="-1"
                        ...
                        <div class="modal-content">
                            <div class="modal-header" data-bs-dismiss="modal">
                                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="2" viewBox="0 0 29 2">
                                    <line id="Line_1" data-name="Line 1" x2="27" transform="translate(1 1)" fill="none"
                                        stroke="#1c1c1c" stroke-linecap="round" stroke-width="2" />
                                </svg>
                            </div>
                            ...
                            <div class="modal-body pt-0">
                                <div class="card">
                                    <h6 class="card-title text-center">
                                        <?= $sonuc["Name"] ?> Detayları
                                    </h6>
                                    <div class="card-header"> <img src="admin/assets/img/<?= $sonuc["ImageUrl"] ?>"
                                            class="card-img-top" data-pagespeed-url-hash="2568255611"
